...
PokeAPI.getPokemonInfoList = (pokemon) => {
...
PokeAPI.getPokemonList = (offset = 0, limit = 10) => {
    ...
    return fetch(url)
        ...
        .then((pokemonsList) => pokemonsList.map(PokeAPI.getPokemonInfoList)) // Return one request for each Pokémon on the Pokémons list
...
// Create method to retrieve Pokemon details for the detail page
